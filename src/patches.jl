...
"""
data type of the points generated by neighborhood(p)
"""
pointtype{U,D,C,N,T}(::Type{FlatCellNM{U,D,C,N,T}}) = MeshPointNM{U,D,C,N,T}


"""
Return the type of the vertices defining the linear simplex chart
"""
vertextype{U,D,C,N,T}(::Type{FlatCellNM{U,D,C,N,T}}) = SVector{U,T}
